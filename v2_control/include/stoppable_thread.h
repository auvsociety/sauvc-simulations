/**
 * This code in this file has been referenced from: https://thispointer.com/c11-how-to-stop-or-terminate-a-thread/
 */ 
...
#include <future>
/*
 * Abstract class that encapsulates promise and future object and
